...
(define-test test-func-with-rest-params
  ...
  (assert-equal (func-with-rest-params) (list))
  (assert-equal (func-with-rest-params 1) (list 1))
   (assert-equal (func-with-rest-params 1 :two 333) (list 1 :two 333)))
...
(define-test test-key-params ()
  "Key params allow the user to specify params in any order"
   (assert-equal (func-with-key-params) (list nil nil))
   (assert-equal (func-with-key-params :a 11 :b 22) (list 11 22))
   ; it is not necessary to specify all key parameters
   (assert-equal (func-with-key-params :b 22) (list nil 22))
...
(define-test test-key-params-can-have-defaults
   ...
   (assert-equal (func-key-params-can-have-defaults) (list 3 nil 4 nil))
   (assert-equal (func-key-params-can-have-defaults :a 3 :b 4) (list 3 T 4 T))
   (assert-equal (func-key-params-can-have-defaults :a 11 :b 22) (list 11 T 22 T))
   (assert-equal (func-key-params-can-have-defaults :b 22) (list 3 nil 22 T))
   ; order is not important
   (assert-equal (func-key-params-can-have-defaults :b 22 :a 0) (list 0 T 22 T)))
...
(define-test test-many-kinds-params
   ...
   (assert-equal (func-with-funky-parameters 1) (list 1 nil 1 (list)))
